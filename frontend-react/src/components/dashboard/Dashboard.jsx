...
const Dashboard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      console.log('There was an error making API reuqest',error)
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="row">
        <div className="col-md-6 mx-auto">
          <form onSubmit={handleSubmit}>
            <input type='text' className='form-control' placeholder='Enter Stock Ticker' onChange={(e)=>setTicker(e.target.value)} required></input>
